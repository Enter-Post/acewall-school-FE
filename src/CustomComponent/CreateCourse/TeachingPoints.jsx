...
const TeachingPointInput = React.memo(
  ({
    ...
    const isOnlyField = teachingPointsFields.length === 1;
    ...
    // Handle remove with confirmation for last field
    const handleRemove = () => {
      if (isOnlyField) {
        return;
      }
      ...
      <div className="mb-6 p-4 border border-gray-200 rounded-lg bg-white focus-within:ring-2 focus-within:ring-blue-500">
        ...
        <div className="flex items-baseline mb-3">
          <span
            ...
            aria-label={`Teaching point ${fieldNumber}`}
          >
            {fieldNumber}
          </span>
          <label
          ...
          >
            Teaching Point <span className="text-red-500" aria-label="required">*</span>
          </label>
        </div>
        ...
        <div className="flex gap-2 w-full">
          <div className="flex-1 relative">
            <input
              ...
              aria-label={`Teaching point ${fieldNumber} content`}
              aria-invalid={!!error}
          ...
          <button
            ...
            aria-label={`Remove teaching point ${fieldNumber}`}
            ...
            title={isOnlyField ? "Cannot remove the last teaching point" : "Remove this teaching point"}
          >
...
TeachingPointInput.displayName = "TeachingPointInput";
