      ...
      <CardContent className="pt-6">
        <div className="space-y-4">
          {submission.totalScore !== undefined ? (
            ...
            <p
              className="text-amber-600 text-center dark:text-amber-400 italic text-lg font-bold mt-4"
              aria-live="polite"
            >
              Thank you for your submission. Your final score will be updated
              soon.
            </p>
          )}
          ...
          {submission && !submission.graded && (
            <div
              className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-md mt-4"
              role="status"
              aria-live="polite"
            >
